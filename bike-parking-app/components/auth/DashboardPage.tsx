...
import { supabaseClient } from "@/config/supabaseClient"; // Adjust the import path as needed
          ...
          {pendingRequests.map((request) => (
            <tr key={request.id}>
              ...
              <td className="td">
                ...
                <button className="button redButton">✘</button>
              </td> {/* Actions buttons at the end */}
            </tr>
          ))}
        </tbody>
      </table>
